                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <img style="width:100px;height:100px;" src='../../jobExpert/login/images/<?php echo $result['image']; ?>' alt="Profile">
                            <div class="pt-2">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="phone" type="text" class="form-control" id="Phone" value="<?php echo $result['phonenumber']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="email" type="email" class="form-control" id="email" onchange="check('<?php echo $result['jusername'] ?>',this.value)" value="<?php echo $result['jusername']; ?>" required>
                        </div>
                    </div>
